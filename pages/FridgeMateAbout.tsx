      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-10">
          ...
          >
            ...
            <p className="text-gray-600">
              Our system analyzes fridge items, suggests recipes, tracks usage,
              and helps you make healthier, easier food decisions every day.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              <p className="text-gray-700 italic">
                ...
                The expiry reminders are a life-saver.”
              </p>
              <p className="text-right text-orange-600 font-semibold mt-2">
                - Rohan Verma
              </p>
